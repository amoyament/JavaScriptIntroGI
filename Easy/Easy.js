...
let firstPerson = 'Clayto';
let secondPerson = 'Aubrey';
...
//If we want to be able to change these variables and log those differences on the fly, we can use a conditional
